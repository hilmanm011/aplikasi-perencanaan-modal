                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="card-header text-center">
                            <h3>Form Edit Estimasi Baru</h3>
                        </div>
                        <div class="card-body">
                            <form action="" method="post">
                                <input type="hidden" name="id" value="<?= $estimasi['id']; ?>">
                                <div class="form-group">
                                    <label for="biaya_material">Biaya Material</label>
                                    <input type="text" name="biaya_material" class="form-control" id="biaya_material" value="<?= $estimasi['biaya_material']; ?>">
