                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="card-header text-center">
                            <h3>Form Tambah Data Modal</h3>
                        </div>
                        <div class="card-body">
                            <form action="" method="post">
                                <div class="form-group">
                                    <label for="biaya_material">Biaya Material :</label>
                                    <input type="text" name="biaya_material" class="form-control" id="biaya_material">
                                    <small class="form-text text-danger"><?= form_error('biaya_material'); ?></small>
                                </div>
                                <div class="form-group">
                                    <label for="biaya_pegawai">Biaya Pegawai :</label>
                                    <input type="text" name="biaya_pegawai" class="form-control" id="biaya_pegawai">
