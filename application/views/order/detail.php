    ...
    <div class="row mt-3">
        <div class="col-md-6">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <h5 class="card-title"><?= $order['no_order']; ?></h5>
                    <h6 class="card-subtitle mb-2 text-muted"><?= $order['tgl_order']; ?></h6>
                    <h6 class="card-subtitle mb-2 text-muted"><?= $order['nama_konsumen']; ?></h6>
                    <h6 class="card-subtitle mb-2 text-muted"><?= $order['nama_project']; ?></h6>
