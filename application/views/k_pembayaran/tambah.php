            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary"><a href="<?= base_url('k_pembayaran'); ?>" class="btn btn-primary">Kembali</a>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="card-body">
                            <form action="" method="post">
                                ...
                                <div class="form-group">
                                    <label for="nominal_pembayaran">Jumlah Pembayaran :</label>
